...
public class UserTest {
    ...
    public void getHowManyUsers() {
        Assert.assertEquals(User.getHowManyUsers(), 3);
    }
    ...
    public void getAllAgeUsers() {
        Assert.assertEquals(User.getAllAgeUsers(), 76);
    }

    @Test
    public void getAgeAverageUsers() {
        Assert.assertEquals(User.getAgeAverageUsers(), 76 / 3);
    }
